...
const Partners = () => {
  ...
  return (
    <section id="partners" className="py-24 bg-gradient-to-br from-gray-50 via-white to-emerald-50/30 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            {filteredPartners.map((partner, index) => {
              ...
              <motion.div
                ...
                whileHover={{ y: -8 }}
                className="group relative bg-white/70 backdrop-blur-lg rounded-2xl p-6 border border-white/50 shadow-lg hover:shadow-2xl hover:border-white/80 transition-all duration-300 h-full flex flex-col"
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    ...
                    {/* Verified Badge */}
                    {partner.verified && (
                      <div className="flex items-center gap-1.5 px-2.5 py-1 bg-emerald-500/10 text-emerald-700 rounded-lg text-xs font-semibold border border-emerald-200">
                  ...
                  <div className="flex justify-center mb-5">
                    <div className="relative">
                      ...
                      {partner.rating && (
                        <motion.div 
                          className="absolute -bottom-1 -right-1 bg-gradient-to-r from-amber-400 to-orange-500 text-white px-2.5 py-1 rounded-full text-xs font-bold shadow-lg flex items-center gap-1 border-2 border-white"
                  ...
                  <div className="text-center flex-grow flex flex-col">
                    ...
                    <p className="text-sm text-gray-600 mb-3 font-medium flex items-center justify-center gap-1">
                    ...
                    {partner.specialties.length > 0 && (
                      <div className="flex flex-wrap justify-center gap-2 mb-4">
                        {partner.specialties.slice(0, 3).map((specialty, idx) => (
                          <span
                            key={idx}
                            className="px-2.5 py-1 bg-white/80 backdrop-blur-sm text-gray-700 rounded-full text-xs font-medium border border-gray-200"
                          >
                            {specialty}
                          </span>
                        ))}
                        {partner.specialties.length > 3 && (
                          <span className="px-2.5 py-1 bg-white/80 backdrop-blur-sm text-gray-500 rounded-full text-xs font-medium border border-gray-200">
                            +{partner.specialties.length - 3}
                          </span>
                        )}
                      </div>
                    ...
                    {/* Stats */}
                    <div className="flex items-center justify-center gap-6 pt-4 mt-auto border-t border-gray-200/50">
        ...
        {!loading && !error && filteredPartners.length === 0 && (
          <div className="text-center py-20">
            <div className="bg-white/70 backdrop-blur-lg border border-white/50 rounded-2xl p-8 max-w-md mx-auto shadow-lg">
              <p className="text-gray-700 text-lg font-semibold">No partners found.</p>
